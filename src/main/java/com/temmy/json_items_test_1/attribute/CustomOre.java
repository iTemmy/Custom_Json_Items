...
import com.temmy.json_items_test_1.listener.BlockBreakListener;
...
public class CustomOre {
            ...
            switch (block.getType()) {
                ...
                case DEEPSLATE_COAL_ORE:
                    if (rnd.nextInt(Main.getChances().get("Phosphorus".toLowerCase())) == 1) {
                        block.getWorld().dropItem(block.getLocation(), Main.getTest().get("phosphorus"));
                ...
                case DEEPSLATE_DIAMOND_ORE:
                    if (rnd.nextInt(Main.getChances().get("Janelite".toLowerCase())) == 1){
                        block.getWorld().dropItem(block.getLocation(), Main.getTest().get("janelite"));
                ...
                case DEEPSLATE_EMERALD_ORE:
                    if (rnd.nextInt(Main.getChances().get("Ellendyte".toLowerCase())) == 1) {
                        block.getWorld().dropItem(block.getLocation(), Main.getTest().get("ellendyte"));
                ...
                case DEEPSLATE_GOLD_ORE:
                    if (rnd.nextInt(Main.getChances().get("Corinthium".toLowerCase())) == 1){
                        block.getWorld().dropItem(block.getLocation(), Main.getTest().get("corthium"));
                        ...
                        block.getWorld().dropItem(block.getLocation(), Main.getTest().get("corinthium"));
                        data.set(Main.getOres().get("Corinthium"), PersistentDataType.INTEGER, 0);
                        return true;
                    }else{
                ...
                case DEEPSLATE_IRON_ORE:
                    if (rnd.nextInt(Main.getChances().get("Jolixanine".toLowerCase())) == 1){
                        block.getWorld().dropItem(block.getLocation(), Main.getTest().get("jolixanine"));
                ...
                case DEEPSLATE_LAPIS_ORE:
                    if (rnd.nextInt(Main.getChances().get("Sapphire".toLowerCase())) == 1){
                        block.getWorld().dropItem(block.getLocation(), Main.getTest().get("Sapphire"));
                ...
                case DEEPSLATE_REDSTONE_ORE:
                    if (rnd.nextInt(Main.getChances().get("Tungsten".toLowerCase())) == 1){
                        block.getWorld().dropItem(block.getLocation(), Main.getTest().get("tungsten"));
            ...
            switch (block.getType()){
                ...
                case NETHER_QUARTZ_ORE:
                    if (rnd.nextInt(Main.getChances().get("Zinc".toLowerCase())) == 1){
                        block.getWorld().dropItem(block.getLocation(), Main.getTest().get("zinc"));
    ...
    private static void test(Player player, NamespacedKey key){
        if (player.getPersistentDataContainer().has(key, PersistentDataType.INTEGER))
            if (Objects.equals(player.getPersistentDataContainer().get(key, PersistentDataType.INTEGER), Main.getChances().get(key.getKey().toLowerCase())))
                log.info("player data == chance detailed in config");
    }
